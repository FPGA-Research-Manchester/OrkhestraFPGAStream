...
using easydspi::dbmstodspi::DMASetupData;
const int kDatapathLength =
    easydspi::dbmstodspi::query_acceleration_constants::kDatapathLength;
const int kDatapathWidth =
    easydspi::dbmstodspi::query_acceleration_constants::kDatapathWidth;
