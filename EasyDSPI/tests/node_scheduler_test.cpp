...
using easydspi::core_interfaces::query_scheduling_data::NodeOperationParameters;
using easydspi::dbmstodspi::NodeScheduler;
using ModulesCombo =
    easydspi::core_interfaces::query_scheduling_data::ConfigurableModulesVector;
using Node = easydspi::core_interfaces::query_scheduling_data::QueryNode;
using OpType = easydspi::core_interfaces::operation_types::QueryOperationType;
