...
/**
 * Class for writing the merge sort configuration data into the module
 * registers.
 */
class MergeSort : public AccelerationModule, public MergeSortInterface {
 public:
  ...
  /**
   * Constructor to setup the merge sort memory access with the memory manager
   *  instance.
  ...
  /**
   * Method to start prefetching data. Module instantiation data is required to
   *  be passed.
  ...
  /**
   * Set which stream is going to get sorted.
