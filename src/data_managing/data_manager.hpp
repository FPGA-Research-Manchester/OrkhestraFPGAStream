...
/**
 * Class to manage the data types and reading and writing of data to and from
 * CSV files.
 */
class DataManager {
 public:
  /**
   * Constructor which need the config to setup the data types.
  ...
  /**
   * Write data from the given CSV file to the TableData structure.
  ...
  /**
   * Helper method to print table data for debugging.
 ...
 private:
  ...
  /**
   * Read the data type configuration file to fill the #data_type_sizes map.
  ...
  /**
   * Helper method for printing out table data. Convert the integers in the
   *  table data to printable strings using
  ...
  /**
   * Helper method to print the string data from tables.
