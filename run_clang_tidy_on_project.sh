...
set_project_files "./tests/core/*"
set_project_files "./tests/core/core_execution/*"
set_project_files "./tests/core/core_input/*"
set_project_files "./tests/core_interfaces/*"
set_project_files "./tests/dbmstodspi/input_handling/*"
set_project_files "./tests/dbmstodspi/query_execution/*"
set_project_files "./tests/dbmstodspi/query_execution/fpga_managing/*"
set_project_files "./tests/dbmstodspi/query_execution/fpga_managing/modules/*"
set_project_files "./tests/dbmstodspi/query_execution/fpga_managing/setup/*"
set_project_files "./tests/dbmstodspi/query_execution/scheduling/*"
