...
class MockFilter : public FilterInterface {
 public:
  ...
  MOCK_METHOD(void, FilterSetCompareTypes,
              (uint32_t chunk_id, uint32_t data_position,
               uint32_t compare_1_type, uint32_t compare_2_type,
               uint32_t compare_3_type, uint32_t compare_4_type),
              (override));
  MOCK_METHOD(void, FilterSetCompareReferenceValue,
              (uint32_t chunk_id, uint32_t data_position,
               uint32_t compare_index, uint32_t compare_reference_value),
              (override));
  MOCK_METHOD(void, FilterSetDNFClauseLiteral,
              (uint32_t dnf_clause_id, uint32_t compare_index,
               uint32_t chunk_id, uint32_t data_position, uint8_t literal_type),
              (override));
