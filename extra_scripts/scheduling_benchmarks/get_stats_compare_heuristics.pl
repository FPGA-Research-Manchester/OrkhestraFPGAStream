...
print "python3 stats_table_generator.py $count_stats $stats_filename $final_stats 1 $pass_fail_json\n";
my $final_processing = system("python3 stats_table_generator.py $count_stats $stats_filename $final_stats 1 $pass_fail_json");
...
print "python3 stats_to_graphs.py $final_stats 1\n"