...
print "python3 stats_table_generator.py $count_stats $stats_filename $final_stats 2 $pass_fail_json\n";
my $final_processing = system("python3 stats_table_generator.py $count_stats $stats_filename $final_stats 2 $pass_fail_json");
...
print "python3 stats_to_graphs.py $stats_filename 2\n"
