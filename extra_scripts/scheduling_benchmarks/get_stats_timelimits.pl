...
my @generator_query_count = (3,6);
my @selectivity = (1);
my @timeouts = (0.1,0.2,0.4,0.6,0.8,1,1.5,2,3);
my $max_node_limit = 20;
my $min_node_limit = 12;
my $equal_scaler = 0;
my $preferred_scaler = 1;
